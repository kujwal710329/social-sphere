...
const MyPostWidget = ({ picturePath }) => {
  ...
  return (
    <WidgetWrapper>
      ...
      {isImage && (
        <Box border={`1px solig ${medium}`} borderRadius="5px" mt="1rem" p="1rem">
      ...
      <FlexBetween>
        ...
        <Button disable={!post} onClick={handlePost} sx={{ color: palette.background.alt, backgroundColor: palette.primary.main, borderRadius: "3rem" }}>
          POST
        </Button>
      </FlexBetween>
    </WidgetWrapper>
